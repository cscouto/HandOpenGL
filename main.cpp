...
public:
    ...
    void setCurvatura1(int dedo,float curv);
    void setCurvatura3(int dedo,float curv);
...
void Mao::desenha()
{
    glPushMatrix();
      ...
      glPushMatrix();
        ...
        glRotatef(curvatura1[3]*0.9,1.0,0.0,0.0);
        glRotatef(curvatura3[3]*0.9,0.0,0.0,1.0);
        indicador.desenha();
      glPopMatrix();
      glPushMatrix();
...
void Mao::setCurvatura3(int dedo,float curv)
{
    curvatura3[dedo] = curv;
}
void Mao::setCurvatura1(int dedo,float curv)
{
    curvatura1[dedo] = curv;
}
